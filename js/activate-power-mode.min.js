    ...
    ([
        function (module,exports,__webpack_require__) {
            ...
            function getColor (el) {
                ...
                else {return window.getComputedStyle(el).color}
            }
            function getCaret() {
            ...
            function createParticle (x,y,color) {return {x:x,y:y,alpha:1,color:color,velocity:{x:-1+Math.random()*2,y:-3.5+Math.random()*2}}}
            function POWERMODE(){
                {
                    var caret=getCaret();
                    ...
                    if (POWERMODE.shake) {
                        ...
                        setTimeout(function(){document.body.style.marginLeft='';document.body.style.marginTop=''},75)
                    }
                }
            };
            ...
            (function(){
                ...
                function getCaretCoordinates (element,position,options) {
                    ...
                    properties.forEach(function(prop){style[prop]=computed[prop]});
                    if (isFirefox) {
                ...
                else {window.getCaretCoordinates=getCaretCoordinates}
            }())
        }
    ])
});